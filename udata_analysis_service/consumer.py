...
TOPICS = os.environ.get("TOPICS", ["datalake"])
...
def consume_kafka():
    ...
    for message in consumer:
        ...
        manage_resource.delay(dataset_id, resource_id, data["value"]["location"], minio_user=os.environ["MINIO_USER"], minio_pwd=os.environ["MINIO_PWD"])
